...
" $Id: amber.vim 2014-02-14 17:36:53 nineties $
...
syn keyword amberStatement      when if else case of while for in continue break return throw try catch import as hiding export with reset shift trait
