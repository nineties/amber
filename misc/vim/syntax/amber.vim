...
" $Id: amber.vim 2014-02-03 16:04:20 nineties $
...
syn keyword amberStatement      when if else case of while for in continue break return throw try catch import as hiding export
