...
" $Id: amber.vim 2014-04-01 21:55:20 nineties $
...
syn keyword amberStatement      when if else case of while for in continue break return throw try catch import hiding as with reset shift class trait require extend
