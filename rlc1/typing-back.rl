(%
 ...
 % 
 % 
 % $Id: typing-back.rl 2010-02-22 18:06:47 nineties $ 
 %);
...
unify: (p0, p1) {
    ...
    if (p0[0] == p1[0]) {
        ...
        if (p0[0] == NODE_BLOCK_T)     { return unify(p0[1], p1[1]); };
...
occur_check: (p0, p1) {
    ...
    if (p1[0] == NODE_BLOCK_T)     { return occur_check(p0, p1[1]); };
...
deref_type: (p0) {
    ...
    if (p0[0] == NODE_BLOCK_T)    { p0[1] = deref_type(p0[1]); return p0; };
